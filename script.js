...
'><img style="width: 50px;
  height: 50px;
  object-fit: cover;
  border-radius: 5px;" src="${item.image}" alt="${item.title}" width="50">${item.title}</td>
      ...
      <td data-id="${item.id}"><button  style="border:none; background-color:none"><img src="./assests/delete.png"></button></td>
    `;
